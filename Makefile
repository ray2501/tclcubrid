...
PKG_SOURCES	=  cubridStubInit.c tclcubrid.c
PKG_OBJECTS	=  cubridStubInit.o tclcubrid.o
...
PKG_TCL_SOURCES =  library/tdbccubrid.tcl
...
PKG_LIB_FILE	= libcubrid0.10.0.so
PKG_LIB_FILE8	= libcubrid0.10.0.so
PKG_LIB_FILE9	= libtcl9cubrid0.10.0.so
PKG_STUB_LIB_FILE = libcubridstub0.10.0.a
...
top_builddir	= /home/danilo/Public/tclcubrid
...
# compiled with.
#DEFS		= $(TCL_DEFS) -DPACKAGE_NAME=\"cubrid\" -DPACKAGE_TARNAME=\"cubrid\" -DPACKAGE_VERSION=\"0.10.0\" -DPACKAGE_STRING=\"cubrid\ 0.10.0\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_cubrid=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
DEFS		= -DPACKAGE_NAME=\"cubrid\" -DPACKAGE_TARNAME=\"cubrid\" -DPACKAGE_VERSION=\"0.10.0\" -DPACKAGE_STRING=\"cubrid\ 0.10.0\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DBUILD_cubrid=/\*\*/ -DHAVE_STDIO_H=1 -DHAVE_STDLIB_H=1 -DHAVE_STRING_H=1 -DHAVE_INTTYPES_H=1 -DHAVE_STDINT_H=1 -DHAVE_STRINGS_H=1 -DHAVE_SYS_STAT_H=1 -DHAVE_SYS_TYPES_H=1 -DHAVE_UNISTD_H=1 -DSTDC_HEADERS=1 -DTcl_Size=int -DUSE_THREAD_ALLOC=1 -D_REENTRANT=1 -D_THREAD_SAFE=1 -DTCL_THREADS=1 -DUSE_TCL_STUBS=1 -DUSE_TCLOO_STUBS=1 -DMODULE_SCOPE=extern\ __attribute__\(\(__visibility__\(\"hidden\"\)\)\) -DHAVE_HIDDEN=1 -DHAVE_CAST_TO_UNION=1 -DHAVE_STDBOOL_H=1 -DTCL_WIDE_INT_IS_LONG=1 -DTCL_CFG_OPTIMIZED=1 -DTCL_MAJOR_VERSION=8 $(PKG_CFLAGS)
